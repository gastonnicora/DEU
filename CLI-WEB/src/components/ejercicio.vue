<template>
    <div class="container ent" data-toggle="modal" v-bind:data-target="'#' + modal" role="button" v-on:keyup.enter="modals()"
        ...
        <div class="row">
            <div class="col-2 p-1 d-flex d-flex align-items-center justify-content-center">
                <video class="imagen" :src="this.$store.state.connection + 'static/videos/' + eje.video.nombre" width="420"
                    height="240"></video>
    ...
    <div class="modal  " v-bind:id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
